            ...
            <div className="mb-12 lg:mb-0">
              ...
              <div className="mt-12">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  I'm open to content partnerships, sponsored posts, and travel collaborations. Please include relevant details in your message to help me understand your proposal better.
                </p>
              </div>
            </div>
                ...
                {submitResult.success ? (
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className={`w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-4 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${
